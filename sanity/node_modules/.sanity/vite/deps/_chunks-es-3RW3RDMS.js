import {
  ...
  usePane,
  useStructureTool
} from "./chunk-CQXSV5TB.js";
import "./chunk-FNTRW6KL.js";
import {
  Button,
  require_react_is,
  useI18nText
} from "./chunk-6IBNYS6B.js";
import "./chunk-OORDQKAU.js";
import {
  ArrowLeftIcon,
  Box,
  dt,
...
import "./chunk-BI7HWRHK.js";
import "./chunk-FQAHX4YX.js";
import {
  require_jsx_runtime
...
function UserComponentPane(props) {
  ...
  let child, component, menuItemGroups, menuItems, restPane;
  if ($[5] !== pane) {
    const {
      child: t02,
      component: t12,
    ...
    child = t02, component = t12, menuItems = t22, menuItemGroups = t32, restPane = t42, $[5] = pane, $[6] = child, $[7] = component, $[8] = menuItemGroups, $[9] = menuItems, $[10] = restPane;
  } else
    child = $[6], component = $[7], menuItemGroups = $[8], menuItems = $[9], restPane = $[10];
  const [ref, setRef] = (0, import_react.useState)(null), {
    title: t0
  } = useI18nText(pane), title = t0 === void 0 ? "" : t0, t1 = ref == null ? void 0 : ref.actionHandlers;
  let t2;
  $[11] !== index || $[12] !== menuItemGroups || $[13] !== menuItems || $[14] !== t1 || $[15] !== title ? (t2 = (0, import_jsx_runtime.jsx)(UserComponentPaneHeader, { actionHandlers: t1, index, menuItems, menuItemGroups, title }), $[11] = index, $[12] = menuItemGroups, $[13] = menuItems, $[14] = t1, $[15] = title, $[16] = t2) : t2 = $[16];
  let t3;
  $[17] !== child || $[18] !== component || $[19] !== paneKey || $[20] !== restPane || $[21] !== restProps ? (t3 = (0, import_react_is.isValidElementType)(component) && (0, import_react.createElement)(component, {
    ...restProps,
    ...restPane,
    ref: setRef,
    child,
    paneKey
  }), $[17] = child, $[18] = component, $[19] = paneKey, $[20] = restPane, $[21] = restProps, $[22] = t3) : t3 = $[22];
  let t4;
  $[23] !== component ? (t4 = (0, import_react.isValidElement)(component) && component, $[23] = component, $[24] = t4) : t4 = $[24];
  let t5;
  $[25] !== t3 || $[26] !== t4 ? (t5 = (0, import_jsx_runtime.jsxs)(UserComponentPaneContent, { children: [
    t3,
    t4
  ] }), $[25] = t3, $[26] = t4, $[27] = t5) : t5 = $[27];
  let t6;
  return $[28] !== paneKey || $[29] !== restProps.isSelected || $[30] !== t2 || $[31] !== t5 ? (t6 = (0, import_jsx_runtime.jsxs)(Pane, { id: paneKey, minWidth: 320, selected: restProps.isSelected, children: [
    t2,
    t5
...
//# sourceMappingURL=_chunks-es-3RW3RDMS.js.map
