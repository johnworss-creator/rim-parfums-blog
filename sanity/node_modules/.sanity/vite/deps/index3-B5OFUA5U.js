...
function useRouterPanesStream() {
  const routerStateSubject = (0, import_react.useMemo)(() => new ReplaySubject(1), []), routerPanes$ = (0, import_react.useMemo)(() => routerStateSubject.asObservable().pipe(map((_routerState) => (_routerState == null ? void 0 : _routerState.panes) || [])), [routerStateSubject]), {
    state: routerState
  } = useRouter();
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-3RW3RDMS.js")),
  document: (0, import_react.lazy)(() => import("./pane-2RUT7S4Q.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-2RUT7S4Q.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-RP7QGJ7M.js"))
};
...
var DocumentTitle = (props) => {
  const $ = (0, import_react_compiler_runtime.c)(7), {
    documentId,
    documentType
  } = props, editState = useEditState(documentId, documentType), schema = useSchema(), {
    t
  } = useTranslation(structureLocaleNamespace), isNewDocument = !(editState == null ? void 0 : editState.published) && !(editState == null ? void 0 : editState.draft), documentValue = (editState == null ? void 0 : editState.draft) || (editState == null ? void 0 : editState.published), schemaType = schema.get(documentType), {
    value,
...
var StructureTool = (0, import_react.memo)(function(t0) {
  ...
  let t13;
  $[17] !== handleRootCollapse || $[18] !== handleRootExpand || $[19] !== t10 || $[20] !== t11 || $[21] !== t12 || $[22] !== t9 ? (t13 = (0, import_jsx_runtime.jsxs)(StyledPaneLayout, { flex: 1, height: t9, minWidth: t10, onCollapse: handleRootCollapse, onExpand: handleRootExpand, children: [
    t11,
    t12
...
//# sourceMappingURL=index3-B5OFUA5U.js.map
